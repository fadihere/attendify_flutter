...
Future<Uint8List> makeMonthlyPdf(
          ...
          Row(children: [
            Container(
                ...
                child: Row(children: [
                  ...
                  Text("${DateTime.now()}", style: TextStyle(fontSize: 12.r))
                ]))
          ])
        ],
      ),
              ...
              TableRow(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      border: Border(
                        top: BorderSide(color: PdfColors.red500, width: 4.0),
                        right: BorderSide(color: PdfColors.red500, width: 4.0),
                        bottom: BorderSide(color: PdfColors.red500, width: 2.0),
                        left: BorderSide(color: PdfColors.red500, width: 4.0),
                      ),
