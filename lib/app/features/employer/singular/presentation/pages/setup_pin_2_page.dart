...
@RoutePage()
class SetupPin2Page extends StatelessWidget {
  final String title;
  const SetupPin2Page({
    super.key,
    required this.title,
                    ...
                    children: List.generate(
                      ...
                      (index) => Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: index < state.confirmPin.length
                      ...
                      child: PinButton(
                        ...
                        onChange: (number) {
                          if (number != null) {
                            context
                                .read<SingularBloc>()
                                .add(AddSetup2Event(pin: number));
                            return;
                          }
                          context.read<SingularBloc>().add(ClearPin2Event());
                        },
                      ),
                    ),
                  ),
